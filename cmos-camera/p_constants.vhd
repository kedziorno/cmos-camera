...
package p_constants is
  ...
  constant a1    :  slv_a := "00010001001100000101010";
  constant a2    :  slv_a := "00000000000000000010100";
  subtype  slv_d is std_logic_vector (c_data_bits - 1 downto 0);
  constant dZ    :  slv_d := (others => '0');
  constant d0    :  slv_d := (others => '0');
  constant c_memory_operation_wait_wr : integer := 2;
  constant c_memory_operation_wait_rd : integer := 3;
